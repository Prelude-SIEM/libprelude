...
class ClientProfile(_object):
    ...
    def GetAnalyzerId(self): return _PreludeEasy.ClientProfile_GetAnalyzerId(self)
    def SetAnalyzerId(self, *args): return _PreludeEasy.ClientProfile_SetAnalyzerId(self, *args)
