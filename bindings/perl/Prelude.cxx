...
#define SWIGTYPE_p_std__mapT_std__string_std__string_t swig_types[33]
...
XS(_wrap_IDMEFClass_getAttributes) {
  {
    ...
    ST(argvi) = SWIG_NewPointerObj((new std::map< std::string,std::string >(static_cast< const std::map< std::string,std::string >& >(result))), SWIGTYPE_p_std__mapT_std__string_std__string_t, SWIG_POINTER_OWN | 0); argvi++ ;
