...
/* Auto-generated by the GenerateIDMEFMessageReadC package (Fri Nov  5 01:49:58 2004) */
	...
	while ( 1 ) {
		...
		switch ( tag ) {
			...
			case MSG_WEBSERVICE_TAG: {
				...
				if ( ! idmef_webservice_read(tmp, msg) )
					goto error;
			...
			case MSG_SNMPSERVICE_TAG: {
				...
				if ( ! idmef_snmpservice_read(tmp, msg) )
					goto error;
	...
	while ( 1 ) {
		...
		switch ( tag ) {
			...
			case MSG_FILE_ACCESS_TAG: {
				...
				if ( ! idmef_file_access_read(tmp, msg) )
					goto error;
	...
	while ( 1 ) {
		...
		switch ( tag ) {
			...
			case MSG_ANALYZER_TAG: {
				...
				if ( ! idmef_analyzer_read(tmp, msg) )
					goto error;
	...
	while ( 1 ) {
		...
		switch ( tag ) {
			...
			case MSG_CONFIDENCE_TAG: {
				...
				if ( ! idmef_confidence_read(tmp, msg) )
					goto error;
	...
	while ( 1 ) {
		...
		switch ( tag ) {
			...
			case MSG_ALERTIDENT_TAG: {
				...
				if ( ! idmef_alertident_read(tmp, msg) )
					goto error;
	...
	while ( 1 ) {
		...
		switch ( tag ) {
			...
			case MSG_ASSESSMENT_TAG: {
				...
				if ( ! idmef_assessment_read(tmp, msg) )
					goto error;
			...
			case MSG_CLASSIFICATION_TAG: {
				...
				if ( ! idmef_classification_read(tmp, msg) )
					goto error;
			...
			case MSG_ADDITIONAL_DATA_TAG: {
				...
				if ( ! idmef_additional_data_read(tmp, msg) )
					goto error;
			...
			case MSG_TOOL_ALERT_TAG: {
				...
				if ( ! idmef_tool_alert_read(tmp, msg) )
					goto error;
			...
			case MSG_CORRELATION_ALERT_TAG: {
				...
				if ( ! idmef_correlation_alert_read(tmp, msg) )
					goto error;
			...
			case MSG_OVERFLOW_ALERT_TAG: {
				...
				if ( ! idmef_overflow_alert_read(tmp, msg) )
					goto error;
