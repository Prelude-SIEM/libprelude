...
/* Auto-generated by the GenerateIDMEFMessageRecvC package (Fri Dec 19 20:41:21 2003) */
	...
	while ( 1 ) {
		...
		switch ( tag ) {
			...
			case MSG_WEBSERVICE_TAG: {
				...
				if ( ! idmef_recv_webservice(msg, tmp) )
					goto error;
			...
			case MSG_SNMPSERVICE_TAG: {
				...
				if ( ! idmef_recv_snmpservice(msg, tmp) )
					goto error;
	...
	while ( 1 ) {
		...
		switch ( tag ) {
			...
			case MSG_FILE_ACCESS_TAG: {
				...
				if ( ! idmef_recv_file_access(msg, tmp) )
					goto error;
	...
	while ( 1 ) {
		...
		switch ( tag ) {
			...
			case MSG_CONFIDENCE_TAG: {
				...
				if ( ! idmef_recv_confidence(msg, tmp) )
					goto error;
	...
	while ( 1 ) {
		...
		switch ( tag ) {
			...
			case MSG_ALERTIDENT_TAG: {
				...
				if ( ! idmef_recv_alertident(msg, tmp) )
					goto error;
	...
	while ( 1 ) {
		...
		switch ( tag ) {
			...
			case MSG_ASSESSMENT_TAG: {
				...
				if ( ! idmef_recv_assessment(msg, tmp) )
					goto error;
			...
			case MSG_ANALYZER_TAG: {
				...
				if ( ! idmef_recv_analyzer(msg, tmp) )
					goto error;
			...
			case MSG_CLASSIFICATION_TAG: {
				...
				if ( ! idmef_recv_classification(msg, tmp) )
					goto error;
			...
			case MSG_ADDITIONAL_DATA_TAG: {
				...
				if ( ! idmef_recv_additional_data(msg, tmp) )
					goto error;
			...
			case MSG_TOOL_ALERT_TAG: {
				...
				if ( ! idmef_recv_tool_alert(msg, tmp) )
					goto error;
			...
			case MSG_CORRELATION_ALERT_TAG: {
				...
				if ( ! idmef_recv_correlation_alert(msg, tmp) )
					goto error;
			...
			case MSG_OVERFLOW_ALERT_TAG: {
				...
				if ( ! idmef_recv_overflow_alert(msg, tmp) )
					goto error;
