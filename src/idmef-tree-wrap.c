...
/* Auto-generated by the GenerateIDMEFTreeWrapC package (Fri Mar  5 18:56:52 2004) */
...
int idmef_spoofed_to_numeric(const char *name)
{
	...
	if ( strcasecmp(name, "idmef-source-spoofed-unknown" ) == 0)
		return IDMEF_SOURCE_SPOOFED_UNKNOWN;

	if ( strcasecmp(name, "idmef-source-spoofed-yes" ) == 0)
		return IDMEF_SOURCE_SPOOFED_YES;

	if ( strcasecmp(name, "idmef-source-spoofed-no" ) == 0)
...
const char *idmef_spoofed_to_string(int val)
{
	switch ( val ) {
		...
		case IDMEF_SOURCE_SPOOFED_UNKNOWN:
			return "idmef-source-spoofed-unknown";

		case IDMEF_SOURCE_SPOOFED_YES:
			return "idmef-source-spoofed-yes";

		case IDMEF_SOURCE_SPOOFED_NO:
			return "idmef-source-spoofed-no";
...
{
	return idmef_value_new_enum_numeric(idmef_type_file_fstype, ptr->fstype);
}
...
int idmef_decoy_to_numeric(const char *name)
{

	if ( strcasecmp(name, "idmef-target-decoy-unknown" ) == 0)
		return IDMEF_TARGET_DECOY_UNKNOWN;

	if ( strcasecmp(name, "idmef-target-decoy-yes" ) == 0)
		return IDMEF_TARGET_DECOY_YES;

	if ( strcasecmp(name, "idmef-target-decoy-no" ) == 0)
...
const char *idmef_decoy_to_string(int val)
{
	switch ( val ) {

		case IDMEF_TARGET_DECOY_UNKNOWN:
			return "idmef-target-decoy-unknown";

		case IDMEF_TARGET_DECOY_YES:
			return "idmef-target-decoy-yes";

		case IDMEF_TARGET_DECOY_NO:
			return "idmef-target-decoy-no";
...
idmef_decoy_t idmef_target_get_decoy(idmef_target_t *ptr)
{
	return ptr->decoy;
}
...
{
	return idmef_value_new_enum_numeric(idmef_type_decoy, ptr->decoy);
}

void idmef_target_set_decoy(idmef_target_t *ptr, idmef_decoy_t decoy)
{
	ptr->decoy = decoy;
}

idmef_decoy_t *idmef_target_new_decoy(idmef_target_t *ptr)
{
	return &ptr->decoy;
}
