...
/* Auto-generated by the GenerateIDMEFTreeWrapC package (Mon Nov  1 15:55:17 2004) */
...
/**
 * idmef_user_new_HASH(0x826282c):
 * @ptr: pointer to a #idmef_user_t object.
 * 
 * Create a new HASH(0x826282c) children of @ptr,
...
/**
 * idmef_process_new_HASH(0x8265d8c):
 * @ptr: pointer to a #idmef_process_t object.
 * 
 * Create a new HASH(0x8265d8c) children of @ptr,
...
/**
 * idmef_process_new_HASH(0x8265dec):
 * @ptr: pointer to a #idmef_process_t object.
 * 
 * Create a new HASH(0x8265dec) children of @ptr,
 * and add it to the tail of @ptr list of #idmef_string_t object.
 * 
 * Returns: a pointer to the created #idmef_string_t object, or NULL if an error occured.
 */
...
/**
 * idmef_webservice_new_HASH(0x8268160):
 * @ptr: pointer to a #idmef_webservice_t object.
 * 
 * Create a new HASH(0x8268160) children of @ptr,
 * and add it to the tail of @ptr list of #idmef_string_t object.
 * 
 * Returns: a pointer to the created #idmef_string_t object, or NULL if an error occured.
 */
...
/**
 * idmef_node_new_HASH(0x826cdd8):
 * @ptr: pointer to a #idmef_node_t object.
 * 
 * Create a new HASH(0x826cdd8) children of @ptr,
...
/**
 * idmef_file_access_new_HASH(0x826f1e0):
 * @ptr: pointer to a #idmef_file_access_t object.
 * 
 * Create a new HASH(0x826f1e0) children of @ptr,
 * and add it to the tail of @ptr list of #idmef_string_t object.
 * 
 * Returns: a pointer to the created #idmef_string_t object, or NULL if an error occured.
 */
...
/**
 * idmef_file_new_HASH(0x82725d0):
 * @ptr: pointer to a #idmef_file_t object.
 * 
 * Create a new HASH(0x82725d0) children of @ptr,
...
/**
 * idmef_file_new_HASH(0x8273018):
 * @ptr: pointer to a #idmef_file_t object.
 * 
 * Create a new HASH(0x8273018) children of @ptr,
...
/**
 * idmef_target_new_HASH(0x82754dc):
 * @ptr: pointer to a #idmef_target_t object.
 * 
 * Create a new HASH(0x82754dc) children of @ptr,
...
/**
 * idmef_assessment_new_HASH(0x827d0f0):
 * @ptr: pointer to a #idmef_assessment_t object.
 * 
 * Create a new HASH(0x827d0f0) children of @ptr,
...
/**
 * idmef_tool_alert_new_HASH(0x827d39c):
 * @ptr: pointer to a #idmef_tool_alert_t object.
 * 
 * Create a new HASH(0x827d39c) children of @ptr,
...
/**
 * idmef_correlation_alert_new_HASH(0x827ea14):
 * @ptr: pointer to a #idmef_correlation_alert_t object.
 * 
 * Create a new HASH(0x827ea14) children of @ptr,
 * and add it to the tail of @ptr list of #idmef_alertident_t object.
 * 
 * Returns: a pointer to the created #idmef_alertident_t object, or NULL if an error occured.
 */
...
/**
 * idmef_alert_new_HASH(0x82807f0):
 * @ptr: pointer to a #idmef_alert_t object.
 * 
 * Create a new HASH(0x82807f0) children of @ptr,
...
/**
 * idmef_alert_new_HASH(0x828085c):
 * @ptr: pointer to a #idmef_alert_t object.
 * 
 * Create a new HASH(0x828085c) children of @ptr,
...
/**
 * idmef_alert_new_HASH(0x82808bc):
 * @ptr: pointer to a #idmef_alert_t object.
 * 
 * Create a new HASH(0x82808bc) children of @ptr,
...
/**
 * idmef_alert_new_HASH(0x828091c):
 * @ptr: pointer to a #idmef_alert_t object.
 * 
 * Create a new HASH(0x828091c) children of @ptr,
...
/**
 * idmef_heartbeat_new_HASH(0x8282c34):
 * @ptr: pointer to a #idmef_heartbeat_t object.
 * 
 * Create a new HASH(0x8282c34) children of @ptr,
 * and add it to the tail of @ptr list of #idmef_additional_data_t object.
 * 
 * Returns: a pointer to the created #idmef_additional_data_t object, or NULL if an error occured.
 */
