...
/* Auto-generated by the GenerateIDMEFTreeWrapC package (Fri Nov  5 19:06:50 2004) */
...
/**
 * idmef_classification_origin_to_numeric:
 * @name: pointer to an IDMEF string representation of a #idmef_classification_origin_t value.
 *
 * Returns: the numeric equivalent of @name, or -1 if @name is not valid.
 */
idmef_classification_origin_t idmef_classification_origin_to_numeric(const char *name)
{
 ...
 * @val: an enumeration value for #idmef_classification_origin_t.
 *
 * Return the IDMEF string equivalent of @val provided #idmef_classification_origin_t value.
 *
 * Returns: a pointer to the string describing @val, or NULL if @val is invalid.
 */
const char *idmef_classification_origin_to_string(idmef_classification_origin_t val)
{
	switch ( val ) {
...
/**
 * idmef_userid_type_to_numeric:
 * @name: pointer to an IDMEF string representation of a #idmef_userid_type_t value.
 *
 * Returns: the numeric equivalent of @name, or -1 if @name is not valid.
 */
idmef_userid_type_t idmef_userid_type_to_numeric(const char *name)
{
 ...
 * @val: an enumeration value for #idmef_userid_type_t.
 *
 * Return the IDMEF string equivalent of @val provided #idmef_userid_type_t value.
 *
 * Returns: a pointer to the string describing @val, or NULL if @val is invalid.
 */
const char *idmef_userid_type_to_string(idmef_userid_type_t val)
{
	switch ( val ) {
...
static void idmef_additional_data_destroy_internal(idmef_additional_data_t *ptr)
{
	...
	prelude_string_destroy_internal(&ptr->meaning);
...
/**
 * idmef_classification_get_origin:
 * @ptr: pointer to a #idmef_classification_t object.
 *
 * Get origin children of the #idmef_classification_t object.
 *
 * Returns: a pointer to a idmef_classification_origin_t object, or NULL if the children object is not set.
 */
...
/**
 * idmef_classification_set_origin:
 * @ptr: pointer to a #idmef_classification_t object.
 * @origin: pointer to a #idmef_classification_origin_t object.
 *
...
/**
 * idmef_classification_new_origin:
 * @ptr: pointer to a #idmef_classification_t object.
 *
 * Create a new origin object, children of #idmef_classification_t.
 * If @ptr already contain a #idmef_classification_origin_t object, then it is destroyed.
 *
 * Returns: A pointer to the newly allocated object, or NULL if an error occured.
 */
...
/**
 * *idmef_classification_get_name:
 * @ptr: pointer to a #idmef_classification_t object.
 *
 * Get name children of the #idmef_classification_t object.
 *
 * Returns: a pointer to a prelude_string_t object, or NULL if the children object is not set.
 */
prelude_string_t *idmef_classification_get_name(idmef_classification_t *ptr)
{
	return &ptr->name;
}
...
void idmef_classification_set_name(idmef_classification_t *ptr, prelude_string_t *name)
{
	prelude_string_destroy_internal(&ptr->name);
...
/**
 * idmef_classification_new_name:
 * @ptr: pointer to a #idmef_classification_t object.
 *
 * Create a new name object, children of #idmef_classification_t.
 * If @ptr already contain a #prelude_string_t object, then it is destroyed.
 *
 * Returns: A pointer to the newly allocated object, or NULL if an error occured.
 */
prelude_string_t *idmef_classification_new_name(idmef_classification_t *ptr)
{
	prelude_string_destroy_internal(&ptr->name);
...
/**
 * *idmef_classification_get_url:
 * @ptr: pointer to a #idmef_classification_t object.
 *
 * Get url children of the #idmef_classification_t object.
 *
 * Returns: a pointer to a prelude_string_t object, or NULL if the children object is not set.
 */
prelude_string_t *idmef_classification_get_url(idmef_classification_t *ptr)
{
	return &ptr->url;
}
...
void idmef_classification_set_url(idmef_classification_t *ptr, prelude_string_t *url)
{
	prelude_string_destroy_internal(&ptr->url);
...
/**
 * idmef_classification_new_url:
 * @ptr: pointer to a #idmef_classification_t object.
 *
 * Create a new url object, children of #idmef_classification_t.
 * If @ptr already contain a #prelude_string_t object, then it is destroyed.
 *
 * Returns: A pointer to the newly allocated object, or NULL if an error occured.
 */
prelude_string_t *idmef_classification_new_url(idmef_classification_t *ptr)
{
	prelude_string_destroy_internal(&ptr->url);
 ...
 * idmef_userid_new:
 * 
 * Create a new #idmef_userid_t object.
 *
 * Returns: a pointer to the newly created object, or NULL if an error occured.
 */
...
/**
 * idmef_userid_ref:
 * @ptr: pointer to a #idmef_userid_t object.
 *
 * Increase @ptr reference count, so that it can be referenced
 * multiple time.
 *
...
/**
 * idmef_userid_get_ident:
 * @ptr: pointer to a #idmef_userid_t object.
 *
 * Get ident children of the #idmef_userid_t object.
 *
...
/**
 * idmef_userid_new_ident:
 * @ptr: pointer to a #idmef_userid_t object.
 *
 * Create a new ident object, children of #idmef_userid_t.
...
/**
 * idmef_userid_get_type:
 * @ptr: pointer to a #idmef_userid_t object.
 *
 * Get type children of the #idmef_userid_t object.
 *
 * Returns: a pointer to a idmef_userid_type_t object, or NULL if the children object is not set.
 */
...
/**
 * idmef_userid_set_type:
 * @ptr: pointer to a #idmef_userid_t object.
 * @type: pointer to a #idmef_userid_type_t object.
 *
 * Set @type object as a children of @ptr.
 * if @ptr already contain an @type object, then it is destroyed,
 * and updated to point to the provided @type object.
...
/**
 * idmef_userid_new_type:
 * @ptr: pointer to a #idmef_userid_t object.
 *
 * Create a new type object, children of #idmef_userid_t.
 * If @ptr already contain a #idmef_userid_type_t object, then it is destroyed.
 *
 * Returns: A pointer to the newly allocated object, or NULL if an error occured.
 */
...
/**
 * *idmef_userid_get_name:
 * @ptr: pointer to a #idmef_userid_t object.
 *
 * Get name children of the #idmef_userid_t object.
 *
 * Returns: a pointer to a prelude_string_t object, or NULL if the children object is not set.
 */
prelude_string_t *idmef_userid_get_name(idmef_userid_t *ptr)
{
	return &ptr->name;
}
...
void idmef_userid_set_name(idmef_userid_t *ptr, prelude_string_t *name)
{
	prelude_string_destroy_internal(&ptr->name);
	memcpy(&ptr->name, name, sizeof (ptr->name));
	free(name);
...
/**
 * idmef_userid_new_name:
 * @ptr: pointer to a #idmef_userid_t object.
 *
 * Create a new name object, children of #idmef_userid_t.
 * If @ptr already contain a #prelude_string_t object, then it is destroyed.
 *
 * Returns: A pointer to the newly allocated object, or NULL if an error occured.
 */
prelude_string_t *idmef_userid_new_name(idmef_userid_t *ptr)
{
	prelude_string_destroy_internal(&ptr->name);
...
/**
 * idmef_userid_get_number:
 * @ptr: pointer to a #idmef_userid_t object.
 *
 * Get number children of the #idmef_userid_t object.
 *
...
/**
 * idmef_userid_new_number:
 * @ptr: pointer to a #idmef_userid_t object.
 *
 * Create a new number object, children of #idmef_userid_t.
...
/**
 * idmef_user_get_next_userid:
 * @ptr: pointer to a #idmef_user_t object.
 * @object: pointer to a #idmef_userid_t object.
 *
 * Get the next #idmef_userid_t object listed in @ptr.
 * When iterating over the idmef_userid_t object listed in @ptr,
 * @object should be set to the latest returned #idmef_userid_t object.
 * 
 * Returns: the next #idmef_userid_t in the list.
 */
...
/**
 * idmef_user_set_userid:
 * @ptr: pointer to a #idmef_user_t object.
 * @object: pointer to a #idmef_userid_t object.
 *
 * Add @object to the tail of @ptr list of #idmef_userid_t object.
 */
...
/**
 * idmef_user_new_HASH(0x8265f90):
 * @ptr: pointer to a #idmef_user_t object.
 * 
 * Create a new HASH(0x8265f90) children of @ptr,
 * and add it to the tail of @ptr list of #idmef_userid_t object.
 * 
 * Returns: a pointer to the created #idmef_userid_t object, or NULL if an error occured.
 */
...
static void idmef_address_destroy_internal(idmef_address_t *ptr)
{
	...
	prelude_string_destroy_internal(&ptr->vlan_name);

	prelude_string_destroy_internal(&ptr->address);

	prelude_string_destroy_internal(&ptr->netmask);
...
/**
 * idmef_process_new_HASH(0x82693a4):
 * @ptr: pointer to a #idmef_process_t object.
 * 
 * Create a new HASH(0x82693a4) children of @ptr,
...
/**
 * idmef_process_new_HASH(0x8269410):
 * @ptr: pointer to a #idmef_process_t object.
 * 
 * Create a new HASH(0x8269410) children of @ptr,
 * and add it to the tail of @ptr list of #prelude_string_t object.
 * 
 * Returns: a pointer to the created #prelude_string_t object, or NULL if an error occured.
 */
...
/**
 * idmef_webservice_new:
 * 
 * Create a new #idmef_webservice_t object.
 *
 * Returns: a pointer to the newly created object, or NULL if an error occured.
 */
...
/**
 * idmef_webservice_ref:
 * @ptr: pointer to a #idmef_webservice_t object.
 *
 * Increase @ptr reference count, so that it can be referenced
 * multiple time.
 *
...
static void idmef_webservice_destroy_internal(idmef_webservice_t *ptr)
{
	...
	prelude_string_destroy_internal(&ptr->cgi);

	prelude_string_destroy_internal(&ptr->http_method);
...
/**
 * *idmef_webservice_get_url:
 * @ptr: pointer to a #idmef_webservice_t object.
 *
 * Get url children of the #idmef_webservice_t object.
 *
 * Returns: a pointer to a prelude_string_t object, or NULL if the children object is not set.
 */
prelude_string_t *idmef_webservice_get_url(idmef_webservice_t *ptr)
{
	return &ptr->url;
}
...
void idmef_webservice_set_url(idmef_webservice_t *ptr, prelude_string_t *url)
{
	prelude_string_destroy_internal(&ptr->url);
	memcpy(&ptr->url, url, sizeof (ptr->url));
	free(url);
...
/**
 * idmef_webservice_new_url:
 * @ptr: pointer to a #idmef_webservice_t object.
 *
 * Create a new url object, children of #idmef_webservice_t.
 * If @ptr already contain a #prelude_string_t object, then it is destroyed.
 *
 * Returns: A pointer to the newly allocated object, or NULL if an error occured.
 */
prelude_string_t *idmef_webservice_new_url(idmef_webservice_t *ptr)
{
	prelude_string_destroy_internal(&ptr->url);
...
/**
 * *idmef_webservice_get_cgi:
 * @ptr: pointer to a #idmef_webservice_t object.
 *
 * Get cgi children of the #idmef_webservice_t object.
 *
 * Returns: a pointer to a prelude_string_t object, or NULL if the children object is not set.
 */
prelude_string_t *idmef_webservice_get_cgi(idmef_webservice_t *ptr)
{
	return &ptr->cgi;
}
...
void idmef_webservice_set_cgi(idmef_webservice_t *ptr, prelude_string_t *cgi)
{
	prelude_string_destroy_internal(&ptr->cgi);
...
/**
 * idmef_webservice_new_cgi:
 * @ptr: pointer to a #idmef_webservice_t object.
 *
 * Create a new cgi object, children of #idmef_webservice_t.
 * If @ptr already contain a #prelude_string_t object, then it is destroyed.
 *
 * Returns: A pointer to the newly allocated object, or NULL if an error occured.
 */
prelude_string_t *idmef_webservice_new_cgi(idmef_webservice_t *ptr)
{
	prelude_string_destroy_internal(&ptr->cgi);
...
/**
 * *idmef_webservice_get_http_method:
 * @ptr: pointer to a #idmef_webservice_t object.
 *
 * Get http_method children of the #idmef_webservice_t object.
 *
 * Returns: a pointer to a prelude_string_t object, or NULL if the children object is not set.
 */
prelude_string_t *idmef_webservice_get_http_method(idmef_webservice_t *ptr)
{
...
/**
 * idmef_webservice_set_http_method:
 * @ptr: pointer to a #idmef_webservice_t object.
...
void idmef_webservice_set_http_method(idmef_webservice_t *ptr, prelude_string_t *http_method)
{
	prelude_string_destroy_internal(&ptr->http_method);
...
/**
 * idmef_webservice_new_http_method:
 * @ptr: pointer to a #idmef_webservice_t object.
 *
 * Create a new http_method object, children of #idmef_webservice_t.
 * If @ptr already contain a #prelude_string_t object, then it is destroyed.
 *
 * Returns: A pointer to the newly allocated object, or NULL if an error occured.
 */
prelude_string_t *idmef_webservice_new_http_method(idmef_webservice_t *ptr)
{
	prelude_string_destroy_internal(&ptr->http_method);
 ...
 * Returns: the next #prelude_string_t in the list.
 */
prelude_string_t *idmef_webservice_get_next_arg(idmef_webservice_t *ptr, prelude_string_t *object)
{
    	return prelude_list_get_next(object, &ptr->arg_list, prelude_string_t, list);
}

/**
 * idmef_webservice_set_arg:
 * @ptr: pointer to a #idmef_webservice_t object.
 * @object: pointer to a #prelude_string_t object.
 *
 * Add @object to the tail of @ptr list of #prelude_string_t object.
 */
void idmef_webservice_set_arg(idmef_webservice_t *ptr, prelude_string_t *object)
{
	prelude_list_add_tail(&object->list, &ptr->arg_list);
}

/**
 * idmef_webservice_new_HASH(0x826a8ec):
 * @ptr: pointer to a #idmef_webservice_t object.
 * 
 * Create a new HASH(0x826a8ec) children of @ptr,
 * and add it to the tail of @ptr list of #prelude_string_t object.
 * 
 * Returns: a pointer to the created #prelude_string_t object, or NULL if an error occured.
 */
prelude_string_t *idmef_webservice_new_arg(idmef_webservice_t *ptr)
{
	prelude_string_t *object;
...
/**
 * idmef_snmpservice_new:
 * 
 * Create a new #idmef_snmpservice_t object.
 *
 * Returns: a pointer to the newly created object, or NULL if an error occured.
 */
...
/**
 * idmef_snmpservice_ref:
 * @ptr: pointer to a #idmef_snmpservice_t object.
 *
 * Increase @ptr reference count, so that it can be referenced
 * multiple time.
 *
...
static void idmef_snmpservice_destroy_internal(idmef_snmpservice_t *ptr)
{
	...
	prelude_string_destroy_internal(&ptr->oid);

	prelude_string_destroy_internal(&ptr->community);

	prelude_string_destroy_internal(&ptr->command);
...
/**
 * *idmef_snmpservice_get_oid:
 * @ptr: pointer to a #idmef_snmpservice_t object.
 *
 * Get oid children of the #idmef_snmpservice_t object.
 *
 * Returns: a pointer to a prelude_string_t object, or NULL if the children object is not set.
 */
prelude_string_t *idmef_snmpservice_get_oid(idmef_snmpservice_t *ptr)
{
	return &ptr->oid;
}
...
void idmef_snmpservice_set_oid(idmef_snmpservice_t *ptr, prelude_string_t *oid)
{
	prelude_string_destroy_internal(&ptr->oid);
...
/**
 * idmef_snmpservice_new_oid:
 * @ptr: pointer to a #idmef_snmpservice_t object.
 *
 * Create a new oid object, children of #idmef_snmpservice_t.
 * If @ptr already contain a #prelude_string_t object, then it is destroyed.
 *
 * Returns: A pointer to the newly allocated object, or NULL if an error occured.
 */
prelude_string_t *idmef_snmpservice_new_oid(idmef_snmpservice_t *ptr)
{
	prelude_string_destroy_internal(&ptr->oid);
...
/**
 * *idmef_snmpservice_get_community:
 * @ptr: pointer to a #idmef_snmpservice_t object.
 *
 * Get community children of the #idmef_snmpservice_t object.
 *
 * Returns: a pointer to a prelude_string_t object, or NULL if the children object is not set.
 */
prelude_string_t *idmef_snmpservice_get_community(idmef_snmpservice_t *ptr)
{
...
/**
 * idmef_snmpservice_set_community:
 * @ptr: pointer to a #idmef_snmpservice_t object.
...
void idmef_snmpservice_set_community(idmef_snmpservice_t *ptr, prelude_string_t *community)
{
	prelude_string_destroy_internal(&ptr->community);
...
/**
 * idmef_snmpservice_new_community:
 * @ptr: pointer to a #idmef_snmpservice_t object.
 *
 * Create a new community object, children of #idmef_snmpservice_t.
 * If @ptr already contain a #prelude_string_t object, then it is destroyed.
 *
 * Returns: A pointer to the newly allocated object, or NULL if an error occured.
 */
prelude_string_t *idmef_snmpservice_new_community(idmef_snmpservice_t *ptr)
{
	prelude_string_destroy_internal(&ptr->community);
...
/**
 * *idmef_snmpservice_get_command:
 * @ptr: pointer to a #idmef_snmpservice_t object.
 *
 * Get command children of the #idmef_snmpservice_t object.
 *
 * Returns: a pointer to a prelude_string_t object, or NULL if the children object is not set.
 */
prelude_string_t *idmef_snmpservice_get_command(idmef_snmpservice_t *ptr)
{
	return &ptr->command;
}
...
void idmef_snmpservice_set_command(idmef_snmpservice_t *ptr, prelude_string_t *command)
{
	prelude_string_destroy_internal(&ptr->command);
...
/**
 * idmef_snmpservice_new_command:
 * @ptr: pointer to a #idmef_snmpservice_t object.
 *
 * Create a new command object, children of #idmef_snmpservice_t.
 * If @ptr already contain a #prelude_string_t object, then it is destroyed.
 *
 * Returns: A pointer to the newly allocated object, or NULL if an error occured.
 */
prelude_string_t *idmef_snmpservice_new_command(idmef_snmpservice_t *ptr)
{
	prelude_string_destroy_internal(&ptr->command);
...
static void idmef_service_destroy_internal(idmef_service_t *ptr)
{
	...
	prelude_string_destroy_internal(&ptr->portlist);

	prelude_string_destroy_internal(&ptr->protocol);
...
/** 
 * idmef_service_get_web:
 * @ptr: pointer to a #idmef_service_t object.
 *
 * Access the web children of @ptr.
 *
 * Returns: a pointer to the #idmef_webservice_t children, or NULL if it is not set.
 */
...
/**
 * idmef_service_set_web:
 * @ptr: pointer to a #idmef_service_t object.
 * @web: pointer to a #idmef_webservice_t object.
 *
 * Set @web object as a children of @ptr.
 * if @ptr already contain a @web object, then it is destroyed,
 * and updated to point to the provided @web object.
 */
...
/**
 * idmef_service_new_web:
 * @ptr: pointer to a #idmef_service_t object.
 *
 * Create a new web object, children of #idmef_service_t.
 * If @ptr already contain a #idmef_webservice_t object, then it is destroyed.
 *
 * Returns: A pointer to the newly allocated object, or NULL if an error occured.
 */
...
/** 
 * idmef_service_get_snmp:
 * @ptr: pointer to a #idmef_service_t object.
 *
 * Access the snmp children of @ptr.
 *
 * Returns: a pointer to the #idmef_snmpservice_t children, or NULL if it is not set.
 */
...
/**
 * idmef_service_set_snmp:
 * @ptr: pointer to a #idmef_service_t object.
 * @snmp: pointer to a #idmef_snmpservice_t object.
 *
 * Set @snmp object as a children of @ptr.
 * if @ptr already contain a @snmp object, then it is destroyed,
 * and updated to point to the provided @snmp object.
 */
...
/**
 * idmef_service_new_snmp:
 * @ptr: pointer to a #idmef_service_t object.
 *
 * Create a new snmp object, children of #idmef_service_t.
 * If @ptr already contain a #idmef_snmpservice_t object, then it is destroyed.
 *
 * Returns: A pointer to the newly allocated object, or NULL if an error occured.
 */
...
static void idmef_node_destroy_internal(idmef_node_t *ptr)
{
	...
	prelude_string_destroy_internal(&ptr->location);
...
/**
 * idmef_node_new_HASH(0x8270688):
 * @ptr: pointer to a #idmef_node_t object.
 * 
 * Create a new HASH(0x8270688) children of @ptr,
...
/**
 * *idmef_file_access_get_userid:
 * @ptr: pointer to a #idmef_file_access_t object.
 *
 * Get userid children of the #idmef_file_access_t object.
 *
 * Returns: a pointer to a idmef_userid_t object, or NULL if the children object is not set.
 */
...
/**
 * idmef_file_access_set_userid:
 * @ptr: pointer to a #idmef_file_access_t object.
 * @userid: pointer to a #idmef_userid_t object.
 *
 * Set @userid object as a children of @ptr.
 * if @ptr already contain an @userid object, then it is destroyed,
 * and updated to point to the provided @userid object.
 */
...
/**
 * idmef_file_access_new_userid:
 * @ptr: pointer to a #idmef_file_access_t object.
 *
 * Create a new userid object, children of #idmef_file_access_t.
 * If @ptr already contain a #idmef_userid_t object, then it is destroyed.
 *
 * Returns: A pointer to the newly allocated object, or NULL if an error occured.
 */
...
/**
 * idmef_file_access_new_HASH(0x82727fc):
 * @ptr: pointer to a #idmef_file_access_t object.
 * 
 * Create a new HASH(0x82727fc) children of @ptr,
 * and add it to the tail of @ptr list of #prelude_string_t object.
 * 
 * Returns: a pointer to the created #prelude_string_t object, or NULL if an error occured.
 */
 ...
 * @ptr: pointer to a #idmef_file_t object.
 * @data_size: pointer to a #uint32_t object.
 *
 ...
 * @ptr: pointer to a #idmef_file_t object.
 * @disk_size: pointer to a #uint32_t object.
 *
...
/**
 * idmef_file_new_HASH(0x8276b54):
 * @ptr: pointer to a #idmef_file_t object.
 * 
 * Create a new HASH(0x8276b54) children of @ptr,
...
/**
 * idmef_file_get_next_file_linkage:
 * @ptr: pointer to a #idmef_file_t object.
...
/**
 * idmef_file_new_HASH(0x8276bc0):
 * @ptr: pointer to a #idmef_file_t object.
 * 
 * Create a new HASH(0x8276bc0) children of @ptr,
...
/**
 * idmef_target_new_HASH(0x827b5dc):
 * @ptr: pointer to a #idmef_target_t object.
 * 
 * Create a new HASH(0x827b5dc) children of @ptr,
...
static void idmef_analyzer_destroy_internal(idmef_analyzer_t *ptr)
{
	...
	prelude_string_destroy_internal(&ptr->manufacturer);

	prelude_string_destroy_internal(&ptr->model);

	prelude_string_destroy_internal(&ptr->version);

	prelude_string_destroy_internal(&ptr->class);

	prelude_string_destroy_internal(&ptr->ostype);

	prelude_string_destroy_internal(&ptr->osversion);
...
static void idmef_impact_destroy_internal(idmef_impact_t *ptr)
{
	...
	prelude_string_destroy_internal(&ptr->description);
...
/**
 * idmef_assessment_new_HASH(0x82827fc):
 * @ptr: pointer to a #idmef_assessment_t object.
 * 
 * Create a new HASH(0x82827fc) children of @ptr,
...
/**
 * idmef_tool_alert_new_HASH(0x82838a0):
 * @ptr: pointer to a #idmef_tool_alert_t object.
 * 
 * Create a new HASH(0x82838a0) children of @ptr,
...
/**
 * idmef_correlation_alert_new_HASH(0x8283a80):
 * @ptr: pointer to a #idmef_correlation_alert_t object.
 * 
 * Create a new HASH(0x8283a80) children of @ptr,
 * and add it to the tail of @ptr list of #idmef_alertident_t object.
 * 
 * Returns: a pointer to the created #idmef_alertident_t object, or NULL if an error occured.
 */
 ...
 * @ptr: pointer to a #idmef_alert_t object.
 *
 * Get ident children of the #idmef_alert_t object.
 *
 * Returns: a pointer to a uint64_t object, or NULL if the children object is not set.
 */
...
/**
 * idmef_alert_new_ident:
 * @ptr: pointer to a #idmef_alert_t object.
 *
 * Create a new ident object, children of #idmef_alert_t.
 * If @ptr already contain a #uint64_t object, then it is destroyed.
 *
 * Returns: A pointer to the newly allocated object, or NULL if an error occured.
 */
...
/**
 * idmef_alert_new_HASH(0x82866dc):
 * @ptr: pointer to a #idmef_alert_t object.
 * 
 * Create a new HASH(0x82866dc) children of @ptr,
...
/**
 * idmef_alert_new_HASH(0x8286748):
 * @ptr: pointer to a #idmef_alert_t object.
 * 
 * Create a new HASH(0x8286748) children of @ptr,
...
/**
 * idmef_alert_get_next_classification:
 * @ptr: pointer to a #idmef_alert_t object.
 * @object: pointer to a #idmef_classification_t object.
 *
 * Get the next #idmef_classification_t object listed in @ptr.
 * When iterating over the idmef_classification_t object listed in @ptr,
 * @object should be set to the latest returned #idmef_classification_t object.
 * 
 * Returns: the next #idmef_classification_t in the list.
 */
 ...
 * @object: pointer to a #idmef_classification_t object.
 *
 * Add @object to the tail of @ptr list of #idmef_classification_t object.
 */
...
/**
 * idmef_alert_new_HASH(0x82867b4):
 * @ptr: pointer to a #idmef_alert_t object.
 * 
 * Create a new HASH(0x82867b4) children of @ptr,
 * and add it to the tail of @ptr list of #idmef_classification_t object.
 * 
 * Returns: a pointer to the created #idmef_classification_t object, or NULL if an error occured.
 */
...
/**
 * idmef_alert_new_HASH(0x8286820):
 * @ptr: pointer to a #idmef_alert_t object.
 * 
 * Create a new HASH(0x8286820) children of @ptr,
 ...
 * @ptr: pointer to a #idmef_heartbeat_t object.
 *
 * Get ident children of the #idmef_heartbeat_t object.
 *
 * Returns: a pointer to a uint64_t object, or NULL if the children object is not set.
 */
...
/**
 * idmef_heartbeat_new_ident:
 * @ptr: pointer to a #idmef_heartbeat_t object.
 *
 * Create a new ident object, children of #idmef_heartbeat_t.
 * If @ptr already contain a #uint64_t object, then it is destroyed.
 *
 * Returns: A pointer to the newly allocated object, or NULL if an error occured.
 */
...
/**
 * idmef_heartbeat_new_HASH(0x8287e94):
 * @ptr: pointer to a #idmef_heartbeat_t object.
 * 
 * Create a new HASH(0x8287e94) children of @ptr,
 * and add it to the tail of @ptr list of #idmef_additional_data_t object.
 * 
 * Returns: a pointer to the created #idmef_additional_data_t object, or NULL if an error occured.
 */
