...
/* Auto-generated by the GenerateIDMEFTreeWrapC package (Thu Oct 21 13:22:43 2004) */
 ...
 *
 * Returns: a pointer to a idmef_string_t object, or NULL if the children object is not set.
 */
 ...
 * @ptr: pointer to a #idmef_additional_data_t object.
 * @meaning: pointer to a #idmef_string_t object.
 *
 ...
 * If @ptr already contain a #idmef_string_t object, then it is destroyed.
 *
 * Returns: A pointer to the newly allocated object, or NULL if an error occured.
 */
 ...
 * @ptr: pointer to a #idmef_classification_t object.
 * @name: pointer to a #idmef_string_t object.
 *
 ...
 * @ptr: pointer to a #idmef_classification_t object.
 * @url: pointer to a #idmef_string_t object.
 *
...
/**
 * idmef_user_new_HASH(0x82615bc):
 * @ptr: pointer to a #idmef_user_t object.
 * 
 * Create a new HASH(0x82615bc) children of @ptr,
 ...
 * @ptr: pointer to a #idmef_address_t object.
 * @vlan_name: pointer to a #idmef_string_t object.
 *
 ...
 * @ptr: pointer to a #idmef_address_t object.
 * @address: pointer to a #idmef_string_t object.
 *
 ...
 * @ptr: pointer to a #idmef_address_t object.
 * @netmask: pointer to a #idmef_string_t object.
 *
 ...
 * @ptr: pointer to a #idmef_process_t object.
 * @path: pointer to a #idmef_string_t object.
 *
 ...
 * @ptr: pointer to a #idmef_process_t object.
 * @object: pointer to a #idmef_string_t object.
 *
 * Get the next #idmef_string_t object listed in @ptr.
 * When iterating over the idmef_string_t object listed in @ptr,
 * @object should be set to the latest returned #idmef_string_t object.
 * 
 * Returns: the next #idmef_string_t in the list.
 */
 ...
 * @object: pointer to a #idmef_string_t object.
 *
 * Add @object to the tail of @ptr list of #idmef_string_t object.
 */
...
/**
 * idmef_process_new_HASH(0x8264b14):
 * @ptr: pointer to a #idmef_process_t object.
 * 
 * Create a new HASH(0x8264b14) children of @ptr,
 * and add it to the tail of @ptr list of #idmef_string_t object.
 * 
 * Returns: a pointer to the created #idmef_string_t object, or NULL if an error occured.
 */
...
/**
 * idmef_process_new_HASH(0x8264b74):
 * @ptr: pointer to a #idmef_process_t object.
 * 
 * Create a new HASH(0x8264b74) children of @ptr,
 * and add it to the tail of @ptr list of #idmef_string_t object.
 * 
 * Returns: a pointer to the created #idmef_string_t object, or NULL if an error occured.
 */
 ...
 * @ptr: pointer to a #idmef_webservice_t object.
 * @cgi: pointer to a #idmef_string_t object.
 *
 ...
 * @ptr: pointer to a #idmef_webservice_t object.
 * @http_method: pointer to a #idmef_string_t object.
 *
...
/**
 * idmef_webservice_new_HASH(0x8266f08):
 * @ptr: pointer to a #idmef_webservice_t object.
 * 
 * Create a new HASH(0x8266f08) children of @ptr,
 * and add it to the tail of @ptr list of #idmef_string_t object.
 * 
 * Returns: a pointer to the created #idmef_string_t object, or NULL if an error occured.
 */
 ...
 * @ptr: pointer to a #idmef_snmpservice_t object.
 * @oid: pointer to a #idmef_string_t object.
 *
 ...
 * @ptr: pointer to a #idmef_snmpservice_t object.
 * @community: pointer to a #idmef_string_t object.
 *
 ...
 * @ptr: pointer to a #idmef_snmpservice_t object.
 * @command: pointer to a #idmef_string_t object.
 *
 ...
 * @ptr: pointer to a #idmef_service_t object.
 * @portlist: pointer to a #idmef_string_t object.
 *
 ...
 * @ptr: pointer to a #idmef_service_t object.
 * @protocol: pointer to a #idmef_string_t object.
 *
 ...
 * @ptr: pointer to a #idmef_node_t object.
 * @location: pointer to a #idmef_string_t object.
 *
...
/**
 * idmef_node_new_HASH(0x826bb58):
 * @ptr: pointer to a #idmef_node_t object.
 * 
 * Create a new HASH(0x826bb58) children of @ptr,
 ...
 * @ptr: pointer to a #idmef_source_t object.
 * @interface: pointer to a #idmef_string_t object.
 *
...
/**
 * idmef_file_access_new_HASH(0x826df60):
 * @ptr: pointer to a #idmef_file_access_t object.
 * 
 * Create a new HASH(0x826df60) children of @ptr,
 * and add it to the tail of @ptr list of #idmef_string_t object.
 * 
 * Returns: a pointer to the created #idmef_string_t object, or NULL if an error occured.
 */
...
/**
 * idmef_file_new_HASH(0x8271350):
 * @ptr: pointer to a #idmef_file_t object.
 * 
 * Create a new HASH(0x8271350) children of @ptr,
...
/**
 * idmef_file_new_HASH(0x8271d80):
 * @ptr: pointer to a #idmef_file_t object.
 * 
 * Create a new HASH(0x8271d80) children of @ptr,
...
/**
 * idmef_target_new_HASH(0x8274244):
 * @ptr: pointer to a #idmef_target_t object.
 * 
 * Create a new HASH(0x8274244) children of @ptr,
 ...
 * @ptr: pointer to a #idmef_analyzer_t object.
 * @manufacturer: pointer to a #idmef_string_t object.
 *
 ...
 * @ptr: pointer to a #idmef_analyzer_t object.
 * @model: pointer to a #idmef_string_t object.
 *
 ...
 * @ptr: pointer to a #idmef_analyzer_t object.
 * @version: pointer to a #idmef_string_t object.
 *
 ...
 * @ptr: pointer to a #idmef_analyzer_t object.
 * @class: pointer to a #idmef_string_t object.
 *
 ...
 * @ptr: pointer to a #idmef_analyzer_t object.
 * @ostype: pointer to a #idmef_string_t object.
 *
 ...
 * @ptr: pointer to a #idmef_analyzer_t object.
 * @osversion: pointer to a #idmef_string_t object.
 *
 ...
 * @ptr: pointer to a #idmef_impact_t object.
 * @description: pointer to a #idmef_string_t object.
 *
...
/**
 * idmef_assessment_new_HASH(0x827beb0):
 * @ptr: pointer to a #idmef_assessment_t object.
 * 
 * Create a new HASH(0x827beb0) children of @ptr,
...
/**
 * idmef_tool_alert_new_HASH(0x827c15c):
 * @ptr: pointer to a #idmef_tool_alert_t object.
 * 
 * Create a new HASH(0x827c15c) children of @ptr,
...
/**
 * idmef_correlation_alert_new_HASH(0x827d834):
 * @ptr: pointer to a #idmef_correlation_alert_t object.
 * 
 * Create a new HASH(0x827d834) children of @ptr,
 * and add it to the tail of @ptr list of #idmef_alertident_t object.
 * 
 * Returns: a pointer to the created #idmef_alertident_t object, or NULL if an error occured.
 */
 ...
 * @ptr: pointer to a #idmef_overflow_alert_t object.
 * @program: pointer to a #idmef_string_t object.
 *
...
/**
 * idmef_alert_new_HASH(0x827f5e0):
 * @ptr: pointer to a #idmef_alert_t object.
 * 
 * Create a new HASH(0x827f5e0) children of @ptr,
...
/**
 * idmef_alert_new_HASH(0x827f64c):
 * @ptr: pointer to a #idmef_alert_t object.
 * 
 * Create a new HASH(0x827f64c) children of @ptr,
...
/**
 * idmef_alert_new_HASH(0x827f6ac):
 * @ptr: pointer to a #idmef_alert_t object.
 * 
 * Create a new HASH(0x827f6ac) children of @ptr,
...
/**
 * idmef_alert_new_HASH(0x827f70c):
 * @ptr: pointer to a #idmef_alert_t object.
 * 
 * Create a new HASH(0x827f70c) children of @ptr,
...
/**
 * idmef_heartbeat_new_HASH(0x82819d4):
 * @ptr: pointer to a #idmef_heartbeat_t object.
 * 
 * Create a new HASH(0x82819d4) children of @ptr,
 * and add it to the tail of @ptr list of #idmef_additional_data_t object.
 * 
 * Returns: a pointer to the created #idmef_additional_data_t object, or NULL if an error occured.
 */
