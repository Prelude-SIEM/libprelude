...
/* Auto-generated by the GenerateIDMEFTreeWrapC package (Sat Mar  6 20:38:07 2004) */
...
{
	return idmef_value_new_enum_numeric(idmef_type_source_spoofed, ptr->spoofed);
}
...
{
	return idmef_value_new_enum_numeric(idmef_type_target_decoy, ptr->decoy);
}
