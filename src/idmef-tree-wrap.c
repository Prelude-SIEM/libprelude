...
/* Auto-generated by the GenerateIDMEFTreeWrapC package (Fri Nov  5 01:49:58 2004) */
...
/**
 * idmef_user_new_HASH(0x8247050):
 * @ptr: pointer to a #idmef_user_t object.
 * 
 * Create a new HASH(0x8247050) children of @ptr,
...
/**
 * idmef_process_new_HASH(0x824a7c4):
 * @ptr: pointer to a #idmef_process_t object.
 * 
 * Create a new HASH(0x824a7c4) children of @ptr,
...
/**
 * idmef_process_new_HASH(0x824a830):
 * @ptr: pointer to a #idmef_process_t object.
 * 
 * Create a new HASH(0x824a830) children of @ptr,
 * and add it to the tail of @ptr list of #idmef_string_t object.
 * 
 * Returns: a pointer to the created #idmef_string_t object, or NULL if an error occured.
 */
...
/**
 * idmef_webservice_new_HASH(0x824c0ec):
 * @ptr: pointer to a #idmef_webservice_t object.
 * 
 * Create a new HASH(0x824c0ec) children of @ptr,
 * and add it to the tail of @ptr list of #idmef_string_t object.
 * 
 * Returns: a pointer to the created #idmef_string_t object, or NULL if an error occured.
 */
...
/**
 * idmef_node_new_HASH(0x8251ab0):
 * @ptr: pointer to a #idmef_node_t object.
 * 
 * Create a new HASH(0x8251ab0) children of @ptr,
...
/**
 * idmef_file_access_new_HASH(0x8253cdc):
 * @ptr: pointer to a #idmef_file_access_t object.
 * 
 * Create a new HASH(0x8253cdc) children of @ptr,
 * and add it to the tail of @ptr list of #idmef_string_t object.
 * 
 * Returns: a pointer to the created #idmef_string_t object, or NULL if an error occured.
 */
...
/**
 * idmef_file_new_HASH(0x8258374):
 * @ptr: pointer to a #idmef_file_t object.
 * 
 * Create a new HASH(0x8258374) children of @ptr,
...
/**
 * idmef_file_new_HASH(0x8258f5c):
 * @ptr: pointer to a #idmef_file_t object.
 * 
 * Create a new HASH(0x8258f5c) children of @ptr,
...
/**
 * idmef_target_new_HASH(0x825ca94):
 * @ptr: pointer to a #idmef_target_t object.
 * 
 * Create a new HASH(0x825ca94) children of @ptr,
...
/**
 * idmef_assessment_new_HASH(0x8263d04):
 * @ptr: pointer to a #idmef_assessment_t object.
 * 
 * Create a new HASH(0x8263d04) children of @ptr,
...
/**
 * idmef_tool_alert_new_HASH(0x8264d58):
 * @ptr: pointer to a #idmef_tool_alert_t object.
 * 
 * Create a new HASH(0x8264d58) children of @ptr,
...
/**
 * idmef_correlation_alert_new_HASH(0x8265da4):
 * @ptr: pointer to a #idmef_correlation_alert_t object.
 * 
 * Create a new HASH(0x8265da4) children of @ptr,
 * and add it to the tail of @ptr list of #idmef_alertident_t object.
 * 
 * Returns: a pointer to the created #idmef_alertident_t object, or NULL if an error occured.
 */
...
/**
 * idmef_alert_new_HASH(0x8267f2c):
 * @ptr: pointer to a #idmef_alert_t object.
 * 
 * Create a new HASH(0x8267f2c) children of @ptr,
...
/**
 * idmef_alert_new_HASH(0x8267f98):
 * @ptr: pointer to a #idmef_alert_t object.
 * 
 * Create a new HASH(0x8267f98) children of @ptr,
...
/**
 * idmef_alert_new_HASH(0x8268004):
 * @ptr: pointer to a #idmef_alert_t object.
 * 
 * Create a new HASH(0x8268004) children of @ptr,
...
/**
 * idmef_alert_new_HASH(0x8268070):
 * @ptr: pointer to a #idmef_alert_t object.
 * 
 * Create a new HASH(0x8268070) children of @ptr,
...
/**
 * idmef_heartbeat_new_HASH(0x8269334):
 * @ptr: pointer to a #idmef_heartbeat_t object.
 * 
 * Create a new HASH(0x8269334) children of @ptr,
 * and add it to the tail of @ptr list of #idmef_additional_data_t object.
 * 
 * Returns: a pointer to the created #idmef_additional_data_t object, or NULL if an error occured.
 */
